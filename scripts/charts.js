...
export function renderCharts({ genreCounts, scoreCounts }, genreChartInstance, scoreChartInstance) {
  ...
  if (!genreChartCanvas || !scoreChartCanvas) {
    return { genreChartInstance, scoreChartInstance }; // Return old instances if canvas isn't found
  }

  // --- 1. Destroy old charts before drawing new ones ---
  // This is crucial for theme switching and re-rendering
  ...
  // --- 2. Set Chart Colors Based on Theme ---
